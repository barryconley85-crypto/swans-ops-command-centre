...
describe("operational signal summary", () => {
  it("surfaces cover and ownership gaps without requiring manual team check-ins", () => {
    ...
    expect(result).toMatchObject({ uncoveredDuties: ["on_call"], unownedTasks: [{ workDate: "2026-09-04", status: "pending", assignedTeamMemberId: null }], unownedHelpRequests: [{ status: "open", ownerTeamMemberId: null }], total: 3 });
