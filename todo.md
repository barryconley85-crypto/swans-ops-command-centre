...
- [ ] Conduct a full live top-to-bottom health check across authenticated desktop and mobile operational workflows, then correct and document confirmed defects.
- [ ] Investigate and improve the discoverability of creating a Help & cover request from the shared register, while preserving the existing My shift entry path.
