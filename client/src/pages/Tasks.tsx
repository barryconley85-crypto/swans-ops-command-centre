...
function TaskItem({ task, selectedDate, onStatus, pending, compact = false, members = [] }: { task: TaskRow; selectedDate: string; onStatus: (status: TaskRow["status"]) => void; pending: boolean; compact?: boolean; members?: any[] }) {
