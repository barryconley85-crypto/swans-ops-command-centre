...
export default function Reports() {
  ...
  const report = useMemo(() => buildOperationalReport(reportId, workspace.state, { rangeStart, rangeEnd }), [reportId, workspace.state, rangeStart, rangeEnd]);
  ...
  const saveView = async () => {
    ...
    try {
      await workspace.add("reportViews", { id: Date.now(), name: viewName.trim(), reportId, rangeStart, rangeEnd, ownerUserId: workspace.authUser?.uid || "" });
