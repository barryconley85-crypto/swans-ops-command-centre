...
import { standardShiftPatterns } from "@/lib/collaboration";
...
export default function Rota() {
  ...
  const usePattern = (pattern: typeof standardShiftPatterns[number]) => { setForm(current => ({ ...current, assignmentType: pattern.assignmentType, startTime: pattern.startTime, endTime: pattern.endTime })); setOpen(true); };
